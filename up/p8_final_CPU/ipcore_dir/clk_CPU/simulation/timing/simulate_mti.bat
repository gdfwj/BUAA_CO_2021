...
vlog -work work clk_CPU_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax clk_CPU_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.clk_CPU_tb work.glbl
